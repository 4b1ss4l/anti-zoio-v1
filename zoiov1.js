...
function liberarSelecaoECopia() {
    const style = document.createElement('style');

    style.id = 'liberar-selecao-estilo';
    ...
    const permitirEvento = (e) => {
        e.stopImmediatePropagation();
    };

    eventosBloqueados.forEach(evento => {
        window.addEventListener(evento, permitirEvento, true);
        document.addEventListener(evento, permitirEvento, true);
    });
